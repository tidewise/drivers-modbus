...
TEST_F(CommonTest,
    it_throws_if_the_amount_of_registers_in_the_reply_is_smaller_than_the_expected)
{
    Frame frame = {
        0x10,
        0x03,
...
TEST_F(CommonTest,
    it_throws_if_the_amount_of_registers_in_the_reply_is_greater_than_the_expected)
{
    Frame frame = {
        0x10,
        0x03,
...
TEST_F(CommonTest,
    it_throws_if_the_amount_of_registers_in_the_reply_would_take_more_space_than_the_frame_payload)
{
    Frame frame = {
        0x10,
        0x03,
        {0x06, 0x1, 0x2, 0x3, 0x4, 0x5}
    };
    ASSERT_THROW(common::parseReadRegisters(nullptr, frame, 2), UnexpectedReply);
}

TEST_F(CommonTest,
    it_throws_if_the_amount_of_registers_in_the_reply_would_take_fewer_space_than_the_frame_payload)
{
    Frame frame = {
        0x10,
        0x03,
        {0x06, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7}
    };
    ASSERT_THROW(common::parseReadRegisters(nullptr, frame, 2), UnexpectedReply);
}
